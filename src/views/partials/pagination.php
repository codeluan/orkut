...
<div class="box feed-item">
	...
	<div class="row">
            <div class="pl-10 tamanho50">
				...
				<?php if ($p > 0): ?>Showing <b><?=$p*$conteudo['perPage']+1;?></b> -<b>
		...
		<div class="tamanho50 textoDireito pr-10">
			...
			<?php if ($p > 0): ?><a href="<?=$base;?>/<?=$url;?>/uid=<?=$id;?>?p=<?=0;?>"><img src="<?=$base;?>/assets/images/prevprev.png" height="20" width="20"></a><?php endif; ?>
																
			<?php if ($p <= 0): ?> <img src="<?=$base;?>/assets/images/prevoff.png" height="20" width="20"> <?php endif; ?>
			<?php if ($p > 0): ?><a href="<?=$base;?>/<?=$url;?>/uid=<?=$id;?>?p=<?=$p-1;?>"><img src="<?=$base;?>/assets/images/prev.png" height="20" width="20"></a><?php endif; ?>
																
			<?php if ($p < $conteudo['pageCount'] -1): ?><a href="<?=$base;?>/<?=$url;?>/uid=<?=$id;?>?p=<?=$p+1;?>"><img src="<?=$base;?>/assets/images/next.png" height="20" width="20"></a><?php endif; ?>
			<?php if ($conteudo['pageCount'] -1 <= $p): ?><img src="<?=$base;?>/assets/images/nextoff.png" height="20" width="20"><?php endif; ?>
																
			<?php if ($p < $conteudo['pageCount'] -1): ?><a href="<?=$base;?>/<?=$url;?>/uid=<?=$id;?>?p=<?=$conteudo['pageCount'] -1;?>"><img src="<?=$base;?>/assets/images/nextnext.png" height="20" width="20"></a><?php endif; ?>
