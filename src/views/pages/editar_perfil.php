...
<section class="coluna-8 pr-10">
    ...
    <?php if(!empty($flash)): ?>
            <?php echo $flash; ?>
        <?php endif; ?>
	<form method="POST" enctype="multipart/form-data" action="<?=$base;?>/editar_perfil/new">
        <div class="tab-body" data-item="tabGeral" style="display: block;">
            <div class="listInforma">
                <ul>
                    <li><p class="textop1">Avatar:</p> <p class="textop2"><input class="btn-eo" type="file" name="avatar"></p></li>
                    <li><p class="textop1">Frase do Perfil:</p> <p class="textop2"><textarea class="btn-eo" id="frase" name="frase" maxlength="100"><?=$user->frase;?></textarea></p></li>
        ...
        <div class="tab-body" data-item="tabPessoal" style="display: none;">
            <div class="listInforma">
                    <ul>
                        ...
                        <li><p class="textop1">do que mais gosto em mim:</p> <p class="textop2"><textarea class="btn-eo" name="pessoal_gostoemmim" maxlength="100"><?=$user->pessoal_gostoemmim;?></textarea></p></li>
                    </ul>
            </div>
        </div>
