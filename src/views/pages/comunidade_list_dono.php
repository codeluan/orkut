                ...
                <li>Communities</li>
                    ...
                    <div class="tabsContainer m-10-button">
                        <div class="tabs">
                            <a href="<?=$base;?>/comunidades">
                                <div class="tab-item" data-for="todas">
								All (<?=$user->somarcomunidades;?>)
                                </div>
                            </a>
                            <a href="<?=$base;?>/comunidadesoudono">
                                <div class="tab-item active" data-for="soudono">
                    ...
                    <div class="m-width-10 pb-5">
                        <?php foreach($comunidades['comunidades'] as $comunidade): ?>
    						<?=$render('comunidades_sou_dono', ['data' => $comunidade, 'loggedUser' => $loggedUser]);?>
						<?php endforeach; ?>
					</div>
                </div>		
                    <?=$render('pagination', ['url' => 'comunidadesoudono', 'conteudo' => $comunidades, 'quantidade'=>$user->somarcomunidadesdono, 'id'=>$user->id]);?>
			</div>					
        </div>
	</section>
</section>  		
